...
const RESET = `(() => {
  ...
  try { BOOK_VIEW = { per: 'month', cum: false }; YJ_TAB = 'pl'; YJ_VIEW = 'compare'; ATT_MISS_ONLY = {}; LED_OPEN = null; CMP_ON = false; if (DB.settings) DB.settings.closedFy = []; paintPeriodBar(); } catch (e) {}
